...
import { Percent, Gift, BarChart, Clock } from 'lucide-react';
...
export default function RewardsPage() {
  ...
  return (
    <div className="bg-gradient-to-b from-[#050b18] to-[#0a1428] min-h-screen text-white pb-16">
      {/* Gift animation that shows on page load */}
      <GiftAnimation
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-24">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 max-w-3xl mx-auto">
            Explore special rewards and offers from our top tailors. Redeem them
            during checkout to enjoy discounts, free items, loyalty points, and
            priority services.
          </p>
        </div>
        ...
        <div className="bg-gray-900/60 backdrop-blur-sm border border-gray-800 rounded-xl p-8 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm">
                Explore available rewards from tailors and find ones that match
                your needs
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm">
                Click &quot;Copy Code&quot; on any reward to save it for
                checkout
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm">
                During checkout, open the Rewards section and apply your saved
                reward
              </p>
            </div>
          </div>
