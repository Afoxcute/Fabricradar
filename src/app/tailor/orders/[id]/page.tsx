...
import { Loader2, ArrowLeft, Check, X, Clock, Package, Phone, Mail, Home, Calendar, User } from 'lucide-react';
...
export default function OrderDetailPage() {
  ...
  // Get order details
  const { data: order, isLoading, error, refetch } = api.orders.getOrderById.useQuery(
    { orderId },
  ...
  const getDeliveryInfo = () => {
    ...
    try {
      ...
      if (typeof order.measurements === 'object' && order.measurements !== null) {
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#050b18] to-[#0a1428] text-white relative">
      ...
      <div className="flex">
        ...
        <div className="ml-64 flex-1 p-8 relative z-10">
          <div className="mb-6">
            <Link href="/tailor/orders" className="text-cyan-500 hover:text-cyan-400 flex items-center mb-2">
          ...
          {isLoading ? (
            ...
            <div className="bg-red-900/30 border border-red-800 text-red-500 px-4 py-3 rounded-lg">
              ...
              <p className="text-sm">There was an error loading this order. Please try again.</p>
            </div>
          ) : order ? (
            <div className="space-y-6">
                ...
                <div className="flex justify-between flex-wrap gap-4">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xl font-bold text-white mt-1">${order.price.toFixed(2)}</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Order Description */}
                <div className="bg-gray-900/60 backdrop-blur-sm border border-gray-800 rounded-xl p-6">
                  <h3 className="text-lg font-semibold mb-4">Order Description</h3>
                  
                  <div className="space-y-4">
                    <div>
                      <p className="text-sm text-gray-400 mb-1">Product:</p>
                      <p className="text-white">{order.description || 'No description available'}</p>
                    </div>
                ...
                <div className="bg-gray-900/60 backdrop-blur-sm border border-gray-800 rounded-xl p-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      <p className="text-sm text-gray-400 mb-1">Delivery Method:</p>
                    ...
                    <div>
                      <p className="text-sm text-gray-400 mb-1">Customer Timeline:</p>
              ...
              {/* Measurements */}
              <div className="bg-gray-900/60 backdrop-blur-sm border border-gray-800 rounded-xl p-6">
                <h3 className="text-lg font-semibold mb-4">Customer Measurements</h3>
                  ...
                  {parseMeasurements().length > 0 ? (
                    parseMeasurements().map(item => (
                      <div key={item.id} className="bg-gray-800/50 p-3 rounded-lg">
                        ...
                        <p className="text-lg font-medium text-white">{item.value} <span className="text-sm text-gray-400">cm</span></p>
                      </div>
                    ))
                  ) : (
            ...
            <div className="bg-yellow-900/30 border border-yellow-800 text-yellow-500 px-4 py-3 rounded-lg">
              ...
              <p className="text-sm">This order doesn&apos;t exist or you don&apos;t have permission to view it.</p>
            </div>
          )}
          
          {/* Communication */}
          <div className="bg-gray-900/60 backdrop-blur-sm border border-gray-800 rounded-xl p-6">
            <h3 className="text-lg font-semibold mb-4">Communication with Customer</h3>
