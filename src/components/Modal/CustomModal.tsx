    ...
    <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex">
      ...
      >
        ...
        >
          {!customHeader && (
            <div
              className={`flex p-6 items-center justify-between pb-4 border-b ${headerClassName}`}
            >
              <div>
                <h2 className="text-xl font-semibold">{title}</h2>
                {subTitle && (
                  <p className="text-sm text-gray-500 max-w-[568px] mt-2">
                    {subTitle}
                  </p>
                )}
              </div>
          ...
          {customHeader}
          <div
            className="mt-4 px-6 pb-6 overflow-auto chatbot-scrollbar"
          ...
          {footer && (
            <div
              className={`flex p-6 items-center justify-between pb-4 border-t ${headerClassName}`}
            >
              {footer}
            </div>
          )}
