...
export function CustomerRewards() {
  ...
  const { data, isLoading, refetch } = api.rewards.getAvailableRewards.useQuery();
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex space-x-2 overflow-x-auto pb-1">
            ...
            <Button
              ...
              className={selectedType === 'DISCOUNT' ? 'bg-green-600 hover:bg-green-700' : ''}
            >
            ...
            <Button
              ...
              className={selectedType === 'FREE_ITEM' ? 'bg-purple-600 hover:bg-purple-700' : ''}
            >
            ...
            <Button
              ...
              className={selectedType === 'POINTS' ? 'bg-blue-600 hover:bg-blue-700' : ''}
            >
            ...
            <Button
              ...
              className={selectedType === 'PRIORITY' ? 'bg-amber-600 hover:bg-amber-700' : ''}
            >
